...
//        литерал типа double.
  ...
  /**
   * 1. Метод должен вернуть сумму двух чисел a и b 2. Дополнительно: сделать проверку если сумма a
   * и b больше чем максимальное значение int то вернуть -1
   **/
   ...
   * Example1: a = 4, b = 5
   * <p>
   * Метод должен вернуть 5 Example2: a = 10, b = 10
   * <p>
  ...
  /**
   * Используя теорему Пифагора, вычислите значение гипотенузы. Квадрат гипотенузы = сумме квадратов
   * катетов
   * <p>
