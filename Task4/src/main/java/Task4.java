...
//    System.out.println(
//        "Введите день и месяц рождения, чтобы узнать свой знак зодиака: " + zodiacSign(2,
//            12)); //вывод задача 4
...
//    System.out.println(
//        calculateCountOfOddElementsInMatrix(new int[]{1, 2, 3, 4, 5, 6})); //вывод задача 7
//    countDevs(111);
//    countDevs(135);
    System.out.println(foobar(6)); //вывод задача 9
    System.out.println(foobar(10)); //вывод задача 9
    System.out.println(foobar(15)); //вывод задача 9
//    printPrimeNumbers();
  }
