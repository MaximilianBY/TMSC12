...
class Main {
    public static void main(String[] args) {
        Car car1 = new Car("Alfa Romeo", "156", "Family Sedan", Car.DIESEL, 63,
                200, 4.6);
        Car car2 = new Car("BMW", "M3 E46", "Sport coupe", Car.BENZIN, 70,
                280, 12);
...
//        System.out.println("Поездка окончена, вы приехали в пункт назначения!" + "\n");
        System.out.println("\n" + car.getBrand() + " " + car.getModel() + " " +
                car.getType() + " проехала " + traveledDistance + " км");
    }
}
