...
public class Connection {
  ...
  private BlockingQueue<java.sql.Connection> pool = new ArrayBlockingQueue<>(MAX_CONNECTION_COUNT,
      true);
  ...
  private void closeConnection(java.sql.Connection connection) throws Exception {
    if (connection != null) {
