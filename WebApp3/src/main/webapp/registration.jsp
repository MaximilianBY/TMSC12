...
<div>
    <nav class="navbar navbar-expand-sm navbar-dark bg-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="${contextPath}/eshop?command=sign-in">Login</a>
    ...
    <form method="post">
        ...
        <div class="col-md-8 offset-md-4">
            ...
            <div class="form-group">
                ...
                <input type="password" class="form-control w-25" id="confirm_password"
            ...
            <button type="submit" class="btn btn-primary" id="saveBtn">Register new user</button>
        </div>
    </form>
</div>
<script>
  ...
  document.getElementById('email').addEventListener('keyup', e => {
    ...
    if (e.target.value === "") {
      ...
      document.getElementById('password').addEventListener('keyup', e => {
        document.getElementById('confirm_password').addEventListener('keyup', c => {
